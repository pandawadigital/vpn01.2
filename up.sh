...
wget -O genssl "https://raw.githubusercontent.com/pandawadigital/vpn01.2/main/ssh/genssl.sh"
...
wget -O slow "https://raw.githubusercontent.com/pandawadigital/vpn01.2/main/slow.sh"
